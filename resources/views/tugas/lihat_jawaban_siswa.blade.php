...
<body>
  ...
  <div class="container">
    <h2 class="text-center mb-3 mt-5 main-heading">jawaban siswa SMK</h2>
    <div class="row row-cols-1 row-cols-md-3 g-4">
      @foreach($kelas as $k)
      <div class="col">
        <a href="{{ route('lihat_jawaban_siswa_2',$k->id) }}" style="text-decoration: none; color: inherit;">
          <div class="card shadow-sm h-100 cursor-pointer1">
            <div class="card-body">
