...
<body>
  ...
  <div class="container">
    <h2 class="text-center mb-3 mt-5 main-heading">Nama Kamu!!!</h2>
    <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="container mt-5">
          <div class="card">
              ...
              <div class="card-body">
                  <form action="{{route('masuk.kelas')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <!-- Submit Button -->
                      <button type="submit" class="btn btn-success">Masuk kelas</button>
                  </form>
              </div>
          </div>
      </div>
    <!-- end form masuk kelas -->
    </div>
  </div>
